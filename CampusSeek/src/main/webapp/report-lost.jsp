...
<head>
    <meta charset="UTF-8">
    <title>Report Lost Item - CampusSeek</title>
            ...
            <div class="col-md-8">
                <div class="card shadow-lg">
                    <div class="card-header bg-danger text-white">
                        <h4 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>Report Lost Item</h4>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="ReportLostServlet" method="post">
                            <div class="mb-3">
                                <label class="form-label">Item Name *</label>
                                <input type="text" class="form-control" name="name" 
                                       placeholder="e.g., iPhone 12, College ID Card" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" rows="3" 
                                          placeholder="Provide detailed description of the item..."></textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="location" 
                                           placeholder="e.g., Library, Cafeteria, Room 101" required>
                                </div>
                                <div class="col-md-6 mb-3">
